...
function ajax_table() {
	...
	jQuery("#jqgrid").jqGrid({
		//data: jqgrid_data,
	    url: _path+"Materiel/get-PPMergeStorage/?StartTime="+StartTime+"&EndTime="+EndTime,
	    datatype: "json",
	    mtype: 'get',
...
$(function(){
	...
	$("#search").click(function(event) {
		var StartTime = $("#StartTime").val(),
			EndTime = $('#EndTime').val();
		path = _path+"Materiel/get-PPMergeStorage?EndTime="+EndTime+"&StartTime="+StartTime;
